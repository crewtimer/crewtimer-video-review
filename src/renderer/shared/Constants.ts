...
export const FirebaseConnectedKey = 'firebaseConnected';
export const N_MOBILE_ID = 'mobileID';
export const N_WAYPOINT = 'waypoint';
...
export const N_CLICKER_WAYPOINT = 'clickerMobileID';
